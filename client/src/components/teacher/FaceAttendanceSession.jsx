    ...
    useEffect(() => {
        const fetchAndInit = async () => {
            try {
                ...
                const res = await axios.get(`${import.meta.env.VITE_API_URL || 'https://colabmernscholarnodeserver.onrender.com'}/api/attendance/course/${course._id}/face-data?semester=${semester}`, config);
