...
const DashboardOverview = ({ user }) => {
  ...
  const fetchLeaderboard = async () => {
    try {
      const res = await axios.get('' + (import.meta.env.VITE_API_URL || 'https://colabmernscholarnodeserver.onrender.com') + '/api/auth/leaderboard');
  ...
  const fetchStats = async () => {
    try {
      ...
      const res = await axios.get('' + (import.meta.env.VITE_API_URL || 'https://colabmernscholarnodeserver.onrender.com') + '/api/attendance/stats/teacher', config);
      setStats(res.data);
