...
const AdminSystemSettings = ({ user }) => {
    ...
    useEffect(() => {
        const fetchSettings = async () => {
            try {
                const res = await axios.get(`${import.meta.env.VITE_API_URL || 'https://colabmernscholarnodeserver.onrender.com'}/api/admin/settings`, {
    ...
    const handleSave = async (e) => {
        ...
        setIsSaving(true);
        try {
            await axios.put(`${import.meta.env.VITE_API_URL || 'https://colabmernscholarnodeserver.onrender.com'}/api/admin/settings`, settings, {
                headers: { Authorization: `Bearer ${user.token}` }
            });
