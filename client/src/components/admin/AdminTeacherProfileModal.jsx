...
const AdminTeacherProfileModal = ({ teacherId, user, onClose }) => {
        ...
        const fetchData = async () => {
            try {
                const [dRes, cRes] = await Promise.all([
                    axios.get(`${window.API_URL}/api/admin/teachers/${teacherId}`, {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            await axios.put(`${window.API_URL}/api/admin/teachers/${teacherId}/assignments`, {
            ...
            if (role !== details.role) {
                await axios.put(`${window.API_URL}/api/admin/users/${teacherId}/role`, { role }, {
                    headers: { Authorization: `Bearer ${user.token}` }
                });
            }
