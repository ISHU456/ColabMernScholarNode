        ...
        const fetchData = async () => {
            try {
                ...
                const [hRes, rRes] = await Promise.all([
                    axios.get(`${window.API_URL}/api/${base}/attendance/history?userId=${userId}&type=${type}`, {
                        headers: { Authorization: `Bearer ${user.token}` }
                    }),
                    axios.get(`${window.API_URL}/api/${base}/attendance/annual-report?userId=${userId}&type=${type}`, {
                        headers: { Authorization: `Bearer ${user.token}` }
                    })
                ]);
