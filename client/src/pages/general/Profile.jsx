...
const Profile = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL || 'https://colabmernscholarnodeserver.onrender.com'}/api/auth/profile`, {
        method: 'PUT',
        headers: {
  ...
  const RequestDeactivation = async () => {
    if(window.confirm("Are you sure you want to request account deactivation?")) {
      try {
        await fetch(`${import.meta.env.VITE_API_URL || 'https://colabmernscholarnodeserver.onrender.com'}/api/auth/profile`, {
          method: 'PUT',
