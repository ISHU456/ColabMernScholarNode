...
const DepartmentSelection = () => {
  ...
  const handleSelect = async (dept) => {
    try {
      ...
      const res = await axios.put('' + (import.meta.env.VITE_API_URL || 'https://colabmernscholarnodeserver.onrender.com') + ${import.meta.env.VITE_API_URL || 'https://colabmernscholarnodeserver.onrender.com'}/api/auth/profile', {
