...
const AssignmentHub = ({ courseId, isTeacher, user, selectedAssignment, setSelectedAssignment, assignments, fetchAssignments, studentSubmissions = [] }) => {
    ...
    const handleAiGenerate = async () => {
        ...
        try {
            const res = await axios.post(`${import.meta.env.VITE_API_URL || 'https://scholarmatrix-api.onrender.com'}/api/chatbot/generate-quiz`, {
    ...
    const handleDeleteAssignment = async (e, asgnId) => {
        ...
        try {
            await axios.delete(`${import.meta.env.VITE_API_URL || 'https://scholarmatrix-api.onrender.com'}/api/assignments/${asgnId}`, {
                headers: { Authorization: `Bearer ${user.token}` }
            });
    ...
    const handleCreate = async (e) => {
        ...
        try {
            await axios.post(`${import.meta.env.VITE_API_URL || 'https://scholarmatrix-api.onrender.com'}/api/assignments/create`, formData, {
                headers: { 
    ...
    const handleGradeSubmission = async (subId) => {
        try {
            await axios.put(`${import.meta.env.VITE_API_URL || 'https://scholarmatrix-api.onrender.com'}/api/assignments/grade/${subId}`, {
    ...
    const handleFileUpload = async (e) => {
        ...
        try {
            await axios.post(`${import.meta.env.VITE_API_URL || 'https://scholarmatrix-api.onrender.com'}/api/assignments/submit`, formData, {
